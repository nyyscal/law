...
const Hero = () => {
  ...
  return (
    <div className="w-full h-[700px] flex items-center justify-center bg-black mb-6">
      {/* Outer container */}
        ...
        <div className="flex flex-col lg:flex-row w-full h-full p-4">
          ...
          <div className="w-full lg:w-1/2 h-full flex flex-col justify-center items-start p-4">
            ...
            <div className="relative flex items-center group cursor-default flex-wrap max-w-full">
              ...
              />
              {/* Heading */}
              <h1 className="text-4xl sm:text-5xl md:text-5xl ml-2 font-bold text-[#FFD700] transition-all duration-300 max-w-full overflow-hidden">
                GC Law Chamber
              </h1>
            </div>
            ...
            <p className="text-xl sm:text-lg mb-4 mt-6 text-white max-w-full sm:max-w-[90%] md:max-w-[80%] lg:max-w-[95%] overflow-hidden">
            ...
            <p className="text-xl sm:text-lg mb-4 text-white max-w-full sm:max-w-[90%] md:max-w-[80%] lg:max-w-[90%] overflow-hidden">
            ...
            <button
              className="border border-white mt-3 -ml-3 flex items-center justify-center text-lg sm:text-xl text-white px-6 sm:px-6 py-3 sm:py-4 rounded-full group hover:scale-105 hover:transition-all hover:text-[#FFD700] hover:border-[#FFD700]"
          ...
          {/* Vertical Line */}
          <div className="w-[2px] rounded-full bg-white h-[80%] mx-4 lg:flex my-8 hidden md:flex items-center justify-center "></div>
